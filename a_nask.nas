...
[FILE "a_nask.nas"]		; 源文件名信息
		...
		GLOBAL	_api_initmalloc, _api_malloc, _api_mallocfree
		GLOBAL	_api_point, _api_linewin, _api_refreshwin
		GLOBAL	_api_getkey
...
_api_mallocfree:			; void api_mallocfree(char *addr, int size);
		PUSH	EBX
		MOV		EDX,10
		MOV		EBX,[CS:0x0020]
		MOV		EAX,[ESP+ 8]		; addr
